...
task main()
{
	...
	while(true)
	{
		...
		writeDebugStreamLine("%i:%i:%i:%i:%i:%i", acS1, acS2, acS3, acS4, acS5, nPgmTime);
		...
		nxtDisplayString(3, "acS2: %i", acS2);
		nxtDisplayString(4, "acS3: %i", acS3);
		nxtDisplayString(5, "acS4: %i", acS4);
		nxtDisplayString(6, "acS5: %i", acS5);
